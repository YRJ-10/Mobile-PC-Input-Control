        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: const [
                  Icon(Icons.power_settings_new_rounded, size: 22, color: Colors.redAccent),
                  SizedBox(width: 10),
                  Text(
                    'Disconnect PC?',
              ...
              const Text(
                'Connection to your PC will be terminated.',
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: const Text('Disconnect', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
            ],
